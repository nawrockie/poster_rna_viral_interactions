...
\title{Identifying Conserved RNA Structures in Viruses using Rfam and Infernal}
...
\section*{The most prevalent viral genomes in GenBank}
...
\begin{footnotesize}
\begin{figure}
\center{\includegraphics[width=13in]{figs/rmark-tree-roc-poster}}
\caption{
...
\section*{Iterative search to expand knowledge of an
  RNA family}

%\begin{footnotesize}
%\begin{figure}
\begin{center}
\includegraphics[width=13in]{figs/iterative-purine-poster-fat}
\end{center}
%\caption{
%Example of iterative searches for the Purine riboswitch (RF00167) in bacterial genomes.}
%\label{fig:iterative}
%\end{figure}
%\end{footnotesize}
...
NIH, National Library of Medicine (EPN), by Howard Hughes Medical Institute (EPN (previously), SRE), by the European
Bioinformatics Institute (IK, JA, AIP), and by the Biotechnology and Biological Sciences
